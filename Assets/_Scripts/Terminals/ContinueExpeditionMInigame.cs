...
public class ContinueExpeditionMinigame : MonoBehaviour, ITerminalMinigame
{
    ...
    [SerializeField] private Rectangle continueExpeditionOutline;
    [SerializeField] private Rectangle saveFileOutline;
    [SerializeField] private Line continueExpeditionBacking;
    ...
    {
        continueExpeditionOutline.Color = x < 0 ? outlineActiveColor : outlineInactiveColor;
        continueExpeditionBacking.Color = x < 0 ? backingActiveColor : backingInactiveColor;
    ...
    public class Result : ITerminalMinigameResult
    {
        ...
        {
            IsReturning = isLoadingSave;
        }
    }

    public ITerminalMinigameResult GetResult()
    {
        return new Result(_isReturning);
    }
